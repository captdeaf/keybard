...
def doit():
    ...
    K("STN_N1", "#₁", "Steno number bar (1)")
    K("STN_N2", "#₂", "Steno number bar (2)")
    K("STN_N3", "#₃", "Steno number bar (3)")
    K("STN_N4", "#₄", "Steno number bar (4)")
    K("STN_N5", "#₅", "Steno number bar (5)")
    K("STN_N6", "#₆", "Steno number bar (6)")
    K("STN_N7", "#₇", "Steno number bar (7)")
    K("STN_N8", "#₈", "Steno number bar (8)")
    K("STN_N9", "#₉", "Steno number bar (9)")
    K("STN_NA", "#₁₀", "Steno number bar (10)")
    K("STN_NB", "#₁₁", "Steno number bar (11)")
    K("STN_NC", "#₁₂", "Steno number bar (12)")

    K("STN_S1", "S–₁", "Steno initial S (upper)")
    K("STN_TL", "T–", "Steno initial T")
    K("STN_PL", "P–", "Steno initial P")
    K("STN_HL", "H–", "Steno initial H")

    K("STN_S2", "S–₂", "Steno initial S (lower)")
    K("STN_KL", "K–", "Steno initial K")
    K("STN_WL", "W–", "Steno initial W")
    K("STN_RL", "R–", "Steno initial R")

    K("STN_ST1", "*₁", "Steno star (upper left)")
    K("STN_ST2", "*₂", "Steno star (lower left)")
    K("STN_ST3", "*₃", "Steno star (upper right)")
    K("STN_ST4", "*₄", "Steno star (lower right)")

    K("STN_A", "–A–", "Steno vowel A")
    K("STN_O", "–O–", "Steno vowel O")
    K("STN_E", "–E–", "Steno vowel E")
    K("STN_U", "–U–", "Steno vowel U")

    K("STN_FR", "–F", "Steno final F")
    K("STN_PR", "–P", "Steno final P")
    K("STN_LR", "–L", "Steno final L")
    K("STN_TR", "–T", "Steno final T")
    K("STN_DR", "–D", "Steno final D")

    K("STN_RR", "–R", "Steno final R")
    K("STN_BR", "–B", "Steno final B")
    K("STN_GR", "–G", "Steno final G")
    K("STN_SR", "–S", "Steno final S")
    K("STN_ZR", "–Z", "Steno final Z")

    K("STN_S3", "SS–", "Steno combined initial SS")
    K("STN_TKL", "TK–", "Steno combined initial TK")
    K("STN_PWL", "PW–", "Steno combined initial PW")
    K("STN_HRL", "HR–", "Steno combined initial HR")
    K("STN_FRR", "–FR", "Steno combined final FR")
    K("STN_PBR", "–PB", "Steno combined final PB")
    K("STN_LGR", "–LG", "Steno combined final LG")
    K("STN_TSR", "–TS", "Steno combined final TS")
    K("STN_DZR", "–DZ", "Steno combined final DZ")
    K("STN_AO", "–AO–", "Steno combined vowel AO")
    K("STN_EU", "–EU–", "Steno combined vowel EU")
