...
const FILE = {
  ...
  //
  //  WARNING: This is currently Svalboard only.
  //
  //  Format:
  //
  ...
  //
  ////////////////////////////////////
  generateKeymapCLayer: (layer, start, ids, nocomma) => {
  ...
  generateKeymapCKeymap: (kbinfo) => {
    ...
    for (let layer = 0; layer < kbinfo.keymap.length; layer++) {
      const map = [
        ...
        ['/* R1 */ ', ...FILE.generateKeymapCLayer(layer, 36, kids), ''],
        ['/* R2 */ ', ...FILE.generateKeymapCLayer(layer, 42, kids), ''],
        ['/* R3 */ ', ...FILE.generateKeymapCLayer(layer, 48, kids), ''],
        ['/* R4 */ ', ...FILE.generateKeymapCLayer(layer, 54, kids), ''],
        [''],
        ['/* L1 */ ', ...FILE.generateKeymapCLayer(layer, 6,  kids), ''],
        ['/* L2 */ ', ...FILE.generateKeymapCLayer(layer, 12, kids), ''],
        ['/* L3 */ ', ...FILE.generateKeymapCLayer(layer, 18, kids), ''],
        ['/* L4 */ ', ...FILE.generateKeymapCLayer(layer, 24, kids), ''],
        [''],
        ['/*', 'Down', 'Pad', 'Up', 'Nail', 'Knuckle', 'Double Down', '*/'],
        ['/* RT */ ', ...FILE.generateKeymapCLayer(layer, 30, tids), ''],
        ['/* LT */ ', ...FILE.generateKeymapCLayer(layer, 0,  tids, true), ''],
      ];
  ...
  generateKeymapC: (kbinfo) => {
    const allSections = [
      '// AUTO-GENERATED BY KEYBARD DO NOT EDIT',
      '// AUTO-GENERATED BY KEYBARD DO NOT EDIT',
      '// AUTO-GENERATED BY KEYBARD DO NOT EDIT',
    ];
    allSections.push(FILE.generateKeymapCKeymap(kbinfo));
    allSections.push(FILE.generateKeymapCMacros(kbinfo));
